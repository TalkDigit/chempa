...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/devalue/index.js';
import destr from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/talk/Documents/GitHub/chempa/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "apiBase": "https://chempapanel.talksolutions.dev/api/v1/front/",
    "cdnUri": "https://chempapanel.talksolutions.dev/storage/",
    "i18n": {
      "baseUrl": "",
      "defaultLocale": "",
...
const serverAssets = [{"baseName":"server","dir":"/Users/talk/Documents/GitHub/chempa/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/talk/Documents/GitHub/chempa","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/talk/Documents/GitHub/chempa/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/talk/Documents/GitHub/chempa/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/talk/Documents/GitHub/chempa/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/talk/Documents/GitHub/chempa/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _O4uqo45xbm = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/talk/Documents/GitHub/chempa";
...
const _s13eEftBAK = defineNitroPlugin((nitroApp) => {
...
const _Gt9wF6T2Sr = defineNitroPlugin((nitroApp) => {
...
const _lazy_KR3CXO = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_KR3CXO, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_KR3CXO, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/talk/Documents/GitHub/chempa/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/talk/Documents/GitHub/chempa/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
